...
model = tflearn.DNN(network, tensorboard_verbose=0,\
		 tensorboard_dir='./models_CNN/logs',\
		 checkpoint_path='./models_CNN/model_conv/nodule-classifier')
...
model.save("./models_CNN/model_conv/nodule-classifier")
print("Network trained and saved as nodule-classifier!")
